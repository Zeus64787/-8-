...
questions_list.append(
        Question('База данных - это', 'Определенным образом организованная совокупность данных', 'Web-страница', 'Список в текстовом документе, сохраненном во внешней памяти', 'Таблица, сохраненная во внешней памяти'))
questions_list.append(
        Question('Фактографическая база данных - это база данных', 'Содержащая сведения об объектах', 'Содержащая графики процессов', 'Сведения о получении фактов, описанных ранее', 'Содержащая каталог фотографий'))
questions_list.append(
        Question('Реляционные базы данных организованы', 'Таблицами', 'Списком', 'Презентацией', 'Мультимедийным файлом'))
